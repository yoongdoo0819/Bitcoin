...
print('NetworkEnvelopeTest Test')
run(NetworkEnvelopeTest('test_parse'))
run(NetworkEnvelopeTest('test_serialize'))

print('VersionMessageTest Test')
run(VersionMessageTest('test_serialize'))

print('GetHeadersMessageTest Test')
run(GetHeadersMessageTest('test_serialize'))

print('HeadersMessageTest Test')
run(HeadersMessageTest('test_parse'))

print('SimpleNodeTest Test')
run(SimpleNodeTest('test_handshake'))