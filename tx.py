...
run(TxTest('test_parse_locktime'))
run(TxTest('test_fee'))
run(TxTest('test_serialize'))
run(TxTest('test_input_value'))
run(TxTest('test_sig_hash'))
run(TxTest('test_verify_p2pkh'))
run(TxTest('test_verify_p2sh'))
run(TxTest('test_sign_input'))
...
print("tx_obj ", tx_obj)    # tx id : 0a4098a83ce3fd6a83d5395ad80c7c2d2ba5ed9ffc4c77a7da7b04c795f20289
print(tx_obj.sign_input(0, priv))
# 입력값에 대한 해제 스크립트를 삽입한 경우 tx id의 값이 달라짐
print("tx_obj ", tx_obj)    # tx id : deaafb19edbeb6e12c355ef06bc10c62be6dcebf6e82cdd84c152b0d28a212d8  
print(tx_obj.serialize().hex())


print("비트코인 공개 주소 생성")
# 비트코인 공개 주소 생성
secret = little_endian_to_int(hash256(b'Yoong'))
print('scret', secret)
